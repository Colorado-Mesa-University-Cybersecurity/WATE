...
def weight_avg_4(epochs, train_loader:DataLoader, val_loader:Dataset, input_size, output_size, device_in_use, model:str = 'Linear'):
    ...
    if model == 'Linear':
        ...
        optimizer4 = optim.SGD(model4.parameters(), lr=0.0000002)  # Stochastic Gradient Descent
        ...
        optimizer5 = optim.SGD(model5.parameters(), lr=0.0000002)  # Stochastic Gradient Descent
        ...
        optimizer6 = optim.SGD(model6.parameters(), lr=0.0000002)  # Stochastic Gradient Descent
        ...
        optimizer7 = optim.SGD(model7.parameters(), lr=0.0000002)  # Stochastic Gradient Descent
...
def weight_avg_8(epochs, train_loader:DataLoader, val_loader:Dataset, input_size, output_size, device_in_use, model:str = 'Linear'):
    ...
    if model == 'Linear':
        ...
        optimizer8 = optim.SGD(model8.parameters(), lr=0.0000002)  # Stochastic Gradient Descent
        ...
        optimizer9 = optim.SGD(model9.parameters(), lr=0.0000002)  # Stochastic Gradient Descent
        ...
        optimizer10 = optim.SGD(model10.parameters(), lr=0.0000002)  # Stochastic Gradient Descent
        ...
        optimizer11 = optim.SGD(model11.parameters(), lr=0.0000002)  # Stochastic Gradient Descent
        ...
        optimizer12 = optim.SGD(model12.parameters(), lr=0.0000002)  # Stochastic Gradient Descent
        ...
        optimizer13 = optim.SGD(model13.parameters(), lr=0.0000002)  # Stochastic Gradient Descent
        ...
        optimizer14 = optim.SGD(model14.parameters(), lr=0.0000002)  # Stochastic Gradient Descent
        ...
        optimizer15 = optim.SGD(model15.parameters(), lr=0.0000002)  # Stochastic Gradient Descent
